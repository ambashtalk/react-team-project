...
export const DivField = styled.div`
  ...
  ${(props) =>
    props.className === "TypeB"
      ? "{display: flex;flex-direction: row;justify-content: space-between; @media screen and (max-width : 768px){display: flex;flex-direction: column;justify-content: center;}}"
      : ""};
  ${(props) =>
    props.className === "TypeC"
      ? "{background-color: #f7f7f7;padding: 12px;box-sizing: border-box;width: 50%;@media screen and (max-width : 768px){width:100%}"
      : ""};
  ${(props) =>
